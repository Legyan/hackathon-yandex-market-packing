...
from app.schemas.order import (ItemBase, OrderCreateResponseSchema, OrderCreateSchema, OrderDataToUser,
...
async def get_order(
    ...
    product_to_user_1 = ProductToUser(
        ...
        image='https://cdn.rbt.ru/images/gen/item_image/image/8581/23/858018_r6048.jpg',
        imei=False,
        honest_sign=True,
        fragility=True,
        count=2
    ...
    r1p1=PackageSchema(
        cartontype='MYB',
        icontype='box',
        items=[ItemBase(sku='sku222222222222222222222', count=3), ItemBase(sku='sku111111111111111111111', count=2)]
    )
    r2p1=PackageSchema(
        cartontype='NONPACK',
        icontype='NONPACK',
    ...
    r2p2=PackageSchema(
        cartontype='EXB',
        icontype='packet',
        items=[ItemBase(sku='sku222222222222222222222', count=2), ItemBase(sku='sku111111111111111111111', count=2)]
    )
    r3p1=PackageSchema(
        cartontype='STRETCH',
        icontype='STRETCH',
        items=[ItemBase(sku='sku222222222222222222222', count=3), ItemBase(sku='sku111111111111111111111', count=1)]
    )
    r3p2=PackageSchema(
        cartontype='ZEX',
        icontype='box',
